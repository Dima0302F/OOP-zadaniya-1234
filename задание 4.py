...
def average_grade_for_lectures(lecturers, course_name):
    ...
    if total_grades:
        average = sum(total_grades) / len(total_grades)
        return average, total_lecturers
    else:
        return 0, 0
...
avg_hw_python, count_hw = average_grade_for_homework(students_list, 'Python')
print(f"   Средняя оценка: {avg_hw_python:.2f}")
print(f"   Количество студентов с оценками: {count_hw}")

print("\n2. Средняя оценка за домашние задания по курсу 'Java':")
avg_hw_java, count_hw_java = average_grade_for_homework(students_list, 'Java')
print(f"   Средняя оценка: {avg_hw_java:.2f}")
print(f"   Количество студентов с оценками: {count_hw_java}")

print("\n3. Средняя оценка за домашние задания по курсу 'Git':")
avg_hw_git, count_hw_git = average_grade_for_homework(students_list, 'Git')
print(f"   Средняя оценка: {avg_hw_git:.2f}")
print(f"   Количество студентов с оценками: {count_hw_git}")

print("\n4. Средняя оценка за лекции по курсу 'Python':")
avg_lect_python, count_lect = average_grade_for_lectures(lecturers_list, 'Python')
print(f"   Средняя оценка: {avg_lect_python:.2f}")
print(f"   Количество лекторов с оценками: {count_lect}")

print("\n5. Средняя оценка за лекции по курсу 'Java':")
avg_lect_java, count_lect_java = average_grade_for_lectures(lecturers_list, 'Java')
print(f"   Средняя оценка: {avg_lect_java:.2f}")
print(f"   Количество лекторов с оценками: {count_lect_java}")
